...
pub type R = crate::R<PORTL_SPEC>;
#[doc = "Register `PORTL` writer"]
pub type W = crate::W<PORTL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pl0(&mut self) -> PL0_W<PORTL_SPEC> {
        PL0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin L1"]
    #[inline(always)]
    #[must_use]
    pub fn pl1(&mut self) -> PL1_W<PORTL_SPEC> {
        PL1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin L2"]
    #[inline(always)]
    #[must_use]
    pub fn pl2(&mut self) -> PL2_W<PORTL_SPEC> {
        PL2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin L3"]
    #[inline(always)]
    #[must_use]
    pub fn pl3(&mut self) -> PL3_W<PORTL_SPEC> {
        PL3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin L4"]
    #[inline(always)]
    #[must_use]
    pub fn pl4(&mut self) -> PL4_W<PORTL_SPEC> {
        PL4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin L5"]
    #[inline(always)]
    #[must_use]
    pub fn pl5(&mut self) -> PL5_W<PORTL_SPEC> {
        PL5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin L6"]
    #[inline(always)]
    #[must_use]
    pub fn pl6(&mut self) -> PL6_W<PORTL_SPEC> {
        PL6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin L7"]
    #[inline(always)]
    #[must_use]
    pub fn pl7(&mut self) -> PL7_W<PORTL_SPEC> {
        PL7_W::new(self, 7)
    }
...
#[doc = "PORT L Data Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`portl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`portl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
