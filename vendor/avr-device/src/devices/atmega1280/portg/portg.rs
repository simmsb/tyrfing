...
pub type R = crate::R<PORTG_SPEC>;
#[doc = "Register `PORTG` writer"]
pub type W = crate::W<PORTG_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pg0(&mut self) -> PG0_W<PORTG_SPEC> {
        PG0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin G1"]
    #[inline(always)]
    #[must_use]
    pub fn pg1(&mut self) -> PG1_W<PORTG_SPEC> {
        PG1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin G2"]
    #[inline(always)]
    #[must_use]
    pub fn pg2(&mut self) -> PG2_W<PORTG_SPEC> {
        PG2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin G3"]
    #[inline(always)]
    #[must_use]
    pub fn pg3(&mut self) -> PG3_W<PORTG_SPEC> {
        PG3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin G4"]
    #[inline(always)]
    #[must_use]
    pub fn pg4(&mut self) -> PG4_W<PORTG_SPEC> {
        PG4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin G5"]
    #[inline(always)]
    #[must_use]
    pub fn pg5(&mut self) -> PG5_W<PORTG_SPEC> {
        PG5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin G6"]
    #[inline(always)]
    #[must_use]
    pub fn pg6(&mut self) -> PG6_W<PORTG_SPEC> {
        PG6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin G7"]
    #[inline(always)]
    #[must_use]
    pub fn pg7(&mut self) -> PG7_W<PORTG_SPEC> {
        PG7_W::new(self, 7)
    }
...
#[doc = "Data Register, Port G\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`portg::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`portg::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
