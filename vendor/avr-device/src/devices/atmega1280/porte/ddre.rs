...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pe0(&mut self) -> PE0_W<DDRE_SPEC> {
        PE0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin E1"]
    #[inline(always)]
    #[must_use]
    pub fn pe1(&mut self) -> PE1_W<DDRE_SPEC> {
        PE1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin E2"]
    #[inline(always)]
    #[must_use]
    pub fn pe2(&mut self) -> PE2_W<DDRE_SPEC> {
        PE2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin E3"]
    #[inline(always)]
    #[must_use]
    pub fn pe3(&mut self) -> PE3_W<DDRE_SPEC> {
        PE3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin E4"]
    #[inline(always)]
    #[must_use]
    pub fn pe4(&mut self) -> PE4_W<DDRE_SPEC> {
        PE4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin E5"]
    #[inline(always)]
    #[must_use]
    pub fn pe5(&mut self) -> PE5_W<DDRE_SPEC> {
        PE5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin E6"]
    #[inline(always)]
    #[must_use]
    pub fn pe6(&mut self) -> PE6_W<DDRE_SPEC> {
        PE6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin E7"]
    #[inline(always)]
    #[must_use]
    pub fn pe7(&mut self) -> PE7_W<DDRE_SPEC> {
        PE7_W::new(self, 7)
    }
