...
pub type R = crate::R<DDRK_SPEC>;
#[doc = "Register `DDRK` writer"]
pub type W = crate::W<DDRK_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pk0(&mut self) -> PK0_W<DDRK_SPEC> {
        PK0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin K1"]
    #[inline(always)]
    #[must_use]
    pub fn pk1(&mut self) -> PK1_W<DDRK_SPEC> {
        PK1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin K2"]
    #[inline(always)]
    #[must_use]
    pub fn pk2(&mut self) -> PK2_W<DDRK_SPEC> {
        PK2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin K3"]
    #[inline(always)]
    #[must_use]
    pub fn pk3(&mut self) -> PK3_W<DDRK_SPEC> {
        PK3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin K4"]
    #[inline(always)]
    #[must_use]
    pub fn pk4(&mut self) -> PK4_W<DDRK_SPEC> {
        PK4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin K5"]
    #[inline(always)]
    #[must_use]
    pub fn pk5(&mut self) -> PK5_W<DDRK_SPEC> {
        PK5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin K6"]
    #[inline(always)]
    #[must_use]
    pub fn pk6(&mut self) -> PK6_W<DDRK_SPEC> {
        PK6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin K7"]
    #[inline(always)]
    #[must_use]
    pub fn pk7(&mut self) -> PK7_W<DDRK_SPEC> {
        PK7_W::new(self, 7)
    }
...
#[doc = "PORT K Data Direction Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddrk::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddrk::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
