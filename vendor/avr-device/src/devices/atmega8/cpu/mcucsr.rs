...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn porf(&mut self) -> PORF_W<MCUCSR_SPEC> {
        PORF_W::new(self, 0)
    }
    #[doc = "Bit 1 - External Reset Flag"]
    #[inline(always)]
    #[must_use]
    pub fn extrf(&mut self) -> EXTRF_W<MCUCSR_SPEC> {
        EXTRF_W::new(self, 1)
    }
    #[doc = "Bit 2 - Brown-out Reset Flag"]
    #[inline(always)]
    #[must_use]
    pub fn borf(&mut self) -> BORF_W<MCUCSR_SPEC> {
        BORF_W::new(self, 2)
    }
    #[doc = "Bit 3 - Watchdog Reset Flag"]
    #[inline(always)]
    #[must_use]
    pub fn wdrf(&mut self) -> WDRF_W<MCUCSR_SPEC> {
        WDRF_W::new(self, 3)
    }
