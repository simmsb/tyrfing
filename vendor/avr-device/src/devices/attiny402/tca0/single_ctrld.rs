...
pub type R = crate::R<SINGLE_CTRLD_SPEC>;
#[doc = "Register `CTRLD` writer"]
pub type W = crate::W<SINGLE_CTRLD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn splitm(&mut self) -> SPLITM_W<SINGLE_CTRLD_SPEC> {
        SPLITM_W::new(self, 0)
    }
...
#[doc = "Control D\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`single_ctrld::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`single_ctrld::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
