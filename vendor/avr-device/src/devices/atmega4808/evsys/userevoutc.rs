...
pub type R = crate::R<USEREVOUTC_SPEC>;
#[doc = "Register `USEREVOUTC` writer"]
pub type W = crate::W<USEREVOUTC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USEREVOUTC_SPEC> {
