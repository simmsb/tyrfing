...
pub type R = crate::R<USERCCLLUT2A_SPEC>;
#[doc = "Register `USERCCLLUT2A` writer"]
pub type W = crate::W<USERCCLLUT2A_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USERCCLLUT2A_SPEC> {
...
#[doc = "User CCL LUT2 Event A\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userccllut2a::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userccllut2a::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
