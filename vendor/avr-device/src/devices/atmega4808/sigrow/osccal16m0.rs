...
pub type R = crate::R<OSCCAL16M0_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<OSCCAL16M0_SPEC> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        core::fmt::Debug::fmt(&self.read(), f)
    }
}
#[doc = "Oscillator Calibration 16 MHz Byte 0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`osccal16m0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
