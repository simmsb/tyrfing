...
pub type W = crate::W<BOOTEND_SPEC>;
...
#[doc = "Boot Section End\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`bootend::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`bootend::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
