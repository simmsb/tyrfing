...
impl TCB2_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TCB2_A {
        match self.bits {
...
pub type TCB2_W<'a, REG> = crate::BitWriter<'a, REG, TCB2_A>;
impl<'a, REG> TCB2_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "WO on PC0"]
...
impl TCB3_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> TCB3_A {
        match self.bits {
...
pub type TCB3_W<'a, REG> = crate::BitWriter<'a, REG, TCB3_A>;
impl<'a, REG> TCB3_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "WO on PB5"]
