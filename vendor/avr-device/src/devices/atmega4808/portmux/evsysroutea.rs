...
impl EVOUTF_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<EVOUTF_A> {
        match self.bits {
...
pub type EVOUTF_W<'a, REG> = crate::BitWriter<'a, REG, EVOUTF_A>;
impl<'a, REG> EVOUTF_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "EVOUT on PF2"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn evoutf(&mut self) -> EVOUTF_W<EVSYSROUTEA_SPEC> {
        EVOUTF_W::new(self, 5)
    }
