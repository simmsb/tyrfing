...
pub type WDTIF_R = crate::BitReader;
#[doc = "Field `WDTIF` writer - Watchdog Timeout Interrupt Flag"]
pub type WDTIF_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wdph(&mut self) -> WDPH_W<WDTCR_SPEC> {
        WDPH_W::new(self, 5)
    }
    #[doc = "Bit 6 - Watchdog Timeout Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn wdtie(&mut self) -> WDTIE_W<WDTCR_SPEC> {
        WDTIE_W::new(self, 6)
    }
    #[doc = "Bit 7 - Watchdog Timeout Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn wdtif(&mut self) -> WDTIF_W<WDTCR_SPEC> {
        WDTIF_W::new(self, 7)
    }
