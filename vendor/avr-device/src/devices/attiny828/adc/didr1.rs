...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn adc11d(&mut self) -> ADC11D_W<DIDR1_SPEC> {
        ADC11D_W::new(self, 3)
    }
    #[doc = "Bit 4 - ADC12 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc12d(&mut self) -> ADC12D_W<DIDR1_SPEC> {
        ADC12D_W::new(self, 4)
    }
    #[doc = "Bit 5 - ADC13 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc13d(&mut self) -> ADC13D_W<DIDR1_SPEC> {
        ADC13D_W::new(self, 5)
    }
    #[doc = "Bit 6 - ADC14 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc14d(&mut self) -> ADC14D_W<DIDR1_SPEC> {
        ADC14D_W::new(self, 6)
    }
    #[doc = "Bit 7 - ADC15 Digital input Disable"]
    #[inline(always)]
    #[must_use]
    pub fn adc15d(&mut self) -> ADC15D_W<DIDR1_SPEC> {
        ADC15D_W::new(self, 7)
    }
