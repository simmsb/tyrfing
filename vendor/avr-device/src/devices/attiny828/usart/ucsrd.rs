...
pub type R = crate::R<UCSRD_SPEC>;
#[doc = "Register `UCSRD` writer"]
pub type W = crate::W<UCSRD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sfde(&mut self) -> SFDE_W<UCSRD_SPEC> {
        SFDE_W::new(self, 5)
    }
    #[doc = "Bit 6 - USART RX Start Flag"]
    #[inline(always)]
    #[must_use]
    pub fn rxs(&mut self) -> RXS_W<UCSRD_SPEC> {
        RXS_W::new(self, 6)
    }
    #[doc = "Bit 7 - USART RX Start Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn rxsie(&mut self) -> RXSIE_W<UCSRD_SPEC> {
        RXSIE_W::new(self, 7)
    }
