...
pub type UMSEL_R = crate::FieldReader<UMSEL_A>;
...
impl crate::FieldSpec for UMSEL_A {
    type Ux = u8;
}
impl UMSEL_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<UMSEL_A> {
        match self.bits {
...
pub type UMSEL_W<'a, REG> = crate::FieldWriter<'a, REG, 2, UMSEL_A>;
