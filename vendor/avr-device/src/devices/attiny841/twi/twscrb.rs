...
impl TWAA_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> TWAA_A {
        match self.bits {
...
pub type TWAA_W<'a, REG> = crate::BitWriter<'a, REG, TWAA_A>;
impl<'a, REG> TWAA_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Send ACK (timing depends on `TWSME`)"]
    #[inline(always)]
    pub fn send_ack(self) -> &'a mut crate::W<REG> {
        self.variant(TWAA_A::SEND_ACK)
    }
    #[doc = "Send NACK (timing depends on `TWSME`)"]
    #[inline(always)]
    pub fn send_nack(self) -> &'a mut crate::W<REG> {
