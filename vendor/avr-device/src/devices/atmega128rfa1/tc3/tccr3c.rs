...
pub type FOC3A_R = crate::BitReader;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> RES_W<TCCR3C_SPEC> {
        RES_W::new(self, 0)
    }
    #[doc = "Bit 5 - Force Output Compare for Channel C"]
    #[inline(always)]
    #[must_use]
    pub fn foc3c(&mut self) -> FOC3C_W<TCCR3C_SPEC> {
        FOC3C_W::new(self, 5)
    }
    #[doc = "Bit 6 - Force Output Compare for Channel B"]
    #[inline(always)]
