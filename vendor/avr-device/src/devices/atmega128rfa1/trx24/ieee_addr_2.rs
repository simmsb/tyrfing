...
pub type R = crate::R<IEEE_ADDR_2_SPEC>;
#[doc = "Register `IEEE_ADDR_2` writer"]
pub type W = crate::W<IEEE_ADDR_2_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ieee_addr_(&mut self) -> IEEE_ADDR__W<IEEE_ADDR_2_SPEC> {
...
#[doc = "Transceiver MAC IEEE Address Register 2\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ieee_addr_2::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ieee_addr_2::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
