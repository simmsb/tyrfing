...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn scbtsrhh(&mut self) -> SCBTSRHH_W<SCBTSRHH_SPEC> {
        SCBTSRHH_W::new(self, 0)
    }
...
#[doc = "Symbol Counter Beacon Timestamp Register HH-Byte\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`scbtsrhh::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`scbtsrhh::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
