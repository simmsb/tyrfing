...
impl CS4_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Option<CS4_A> {
        match self.bits {
...
pub type CS4_W<'a, REG> = crate::FieldWriter<'a, REG, 3, CS4_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn wgm4(&mut self) -> WGM4_W<TCCR4B_SPEC> {
        WGM4_W::new(self, 3)
    }
    #[doc = "Bit 5 - Reserved Bit"]
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> RES_W<TCCR4B_SPEC> {
        RES_W::new(self, 5)
    }
    #[doc = "Bit 6 - Input Capture 4 Edge Select"]
    #[inline(always)]
    #[must_use]
    pub fn ices4(&mut self) -> ICES4_W<TCCR4B_SPEC> {
        ICES4_W::new(self, 6)
    }
    #[doc = "Bit 7 - Input Capture 4 Noise Canceller"]
    #[inline(always)]
    #[must_use]
    pub fn icnc4(&mut self) -> ICNC4_W<TCCR4B_SPEC> {
        ICNC4_W::new(self, 7)
    }
