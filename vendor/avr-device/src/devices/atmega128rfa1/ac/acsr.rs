...
impl ACIS_R {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> ACIS_A {
        match self.bits {
    ...
    REG::Ux: From<u8>,
{
    #[doc = "Interrupt on Toggle"]
    #[inline(always)]
    pub fn interrupt_on_toggle(self) -> &'a mut crate::W<REG> {
        self.variant(ACIS_A::INTERRUPT_ON_TOGGLE)
    }
    #[doc = "Interrupt on Falling Edge"]
    #[inline(always)]
    pub fn interrupt_on_falling_edge(self) -> &'a mut crate::W<REG> {
        self.variant(ACIS_A::INTERRUPT_ON_FALLING_EDGE)
    }
    #[doc = "Interrupt on Rising Edge"]
    #[inline(always)]
    pub fn interrupt_on_rising_edge(self) -> &'a mut crate::W<REG> {
...
pub type ACO_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn acic(&mut self) -> ACIC_W<ACSR_SPEC> {
        ACIC_W::new(self, 2)
    }
    #[doc = "Bit 3 - Analog Comparator Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn aco(&mut self) -> ACO_W<ACSR_SPEC> {
        ACO_W::new(self, 5)
    }
    #[doc = "Bit 6 - Analog Comparator Bandgap Select"]
    #[inline(always)]
