...
pub type R = crate::R<DRTRAM3_SPEC>;
#[doc = "Register `DRTRAM3` writer"]
pub type W = crate::W<DRTRAM3_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn endrt(&mut self) -> ENDRT_W<DRTRAM3_SPEC> {
        ENDRT_W::new(self, 4)
    }
    #[doc = "Bit 5 - DRT Switch OK"]
    #[inline(always)]
    #[must_use]
    pub fn drtswok(&mut self) -> DRTSWOK_W<DRTRAM3_SPEC> {
        DRTSWOK_W::new(self, 5)
    }
    #[doc = "Bits 6:7 - Reserved"]
    #[inline(always)]
    #[must_use]
    pub fn res(&mut self) -> RES_W<DRTRAM3_SPEC> {
        RES_W::new(self, 6)
    }
