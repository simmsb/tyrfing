...
pub type CTC0_R = crate::BitReader;
#[doc = "Field `CTC0` writer - Clear Timer on Compare Match"]
pub type CTC0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cs0(&mut self) -> CS0_W<TCCR0A_SPEC> {
        CS0_W::new(self, 0)
    }
    #[doc = "Bit 3 - Clear Timer on Compare Match"]
    #[inline(always)]
    #[must_use]
    pub fn ctc0(&mut self) -> CTC0_W<TCCR0A_SPEC> {
        CTC0_W::new(self, 3)
    }
