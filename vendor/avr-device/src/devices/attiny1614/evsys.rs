...
pub struct RegisterBlock {
    ...
    asyncuser11: ASYNCUSER11,
    asyncuser12: ASYNCUSER12,
    _reserved21: [u8; 0x03],
    syncuser0: SYNCUSER0,
    syncuser1: SYNCUSER1,
}
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn asyncch2(&self) -> &ASYNCCH2 {
        &self.asyncch2
    }
    #[doc = "0x05 - Asynchronous Channel 3 Generator Selection"]
    #[inline(always)]
    pub const fn asyncch3(&self) -> &ASYNCCH3 {
        &self.asyncch3
    }
    ...
    #[inline(always)]
    pub const fn asyncuser11(&self) -> &ASYNCUSER11 {
        &self.asyncuser11
    }
    #[doc = "0x1e - Asynchronous User Ch 12 Input Selection - ADC1"]
    #[inline(always)]
    pub const fn asyncuser12(&self) -> &ASYNCUSER12 {
        &self.asyncuser12
    }
    ...
    #[inline(always)]
    pub const fn syncuser1(&self) -> &SYNCUSER1 {
        &self.syncuser1
    }
}
...
pub mod asyncch1;
#[doc = "ASYNCCH2 (rw) register accessor: Asynchronous Channel 2 Generator Selection\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`asyncch2::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`asyncch2::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@asyncch2`]
module"]
pub type ASYNCCH2 = crate::Reg<asyncch2::ASYNCCH2_SPEC>;
#[doc = "Asynchronous Channel 2 Generator Selection"]
pub mod asyncch2;
#[doc = "ASYNCCH3 (rw) register accessor: Asynchronous Channel 3 Generator Selection\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`asyncch3::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`asyncch3::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@asyncch3`]
module"]
...
pub mod asyncuser10;
#[doc = "ASYNCUSER11 (rw) register accessor: Asynchronous User Ch 11 Input Selection - TCB1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`asyncuser11::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`asyncuser11::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@asyncuser11`]
module"]
pub type ASYNCUSER11 = crate::Reg<asyncuser11::ASYNCUSER11_SPEC>;
#[doc = "Asynchronous User Ch 11 Input Selection - TCB1"]
pub mod asyncuser11;
#[doc = "ASYNCUSER12 (rw) register accessor: Asynchronous User Ch 12 Input Selection - ADC1\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`asyncuser12::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`asyncuser12::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@asyncuser12`]
module"]
...
pub mod syncstrobe;
#[doc = "SYNCUSER0 (rw) register accessor: Synchronous User Ch 0 - TCA0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`syncuser0::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`syncuser0::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@syncuser0`]
module"]
pub type SYNCUSER0 = crate::Reg<syncuser0::SYNCUSER0_SPEC>;
#[doc = "Synchronous User Ch 0 - TCA0"]
pub mod syncuser0;
#[doc = "SYNCUSER1 (rw) register accessor: Synchronous User Ch 1 - USART0\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`syncuser1::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`syncuser1::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@syncuser1`]
module"]
