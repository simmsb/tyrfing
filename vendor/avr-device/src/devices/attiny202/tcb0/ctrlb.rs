...
pub type TCB_ASYNC_R = crate::BitReader;
#[doc = "Field `TCB_ASYNC` writer - Asynchronous Enable"]
pub type TCB_ASYNC_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tcb_async(&mut self) -> TCB_ASYNC_W<CTRLB_SPEC> {
        TCB_ASYNC_W::new(self, 6)
    }
