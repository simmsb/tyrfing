#[doc = "Register `USERTCD0INPUTB` reader"]
pub type R = crate::R<USERTCD0INPUTB_SPEC>;
#[doc = "Register `USERTCD0INPUTB` writer"]
pub type W = crate::W<USERTCD0INPUTB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn user(&mut self) -> USER_W<USERTCD0INPUTB_SPEC> {
        USER_W::new(self, 0)
    }
...
#[doc = "User 41 - TCD0 Event B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usertcd0inputb::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usertcd0inputb::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USERTCD0INPUTB_SPEC;
impl crate::RegisterSpec for USERTCD0INPUTB_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`usertcd0inputb::R`](R) reader structure"]
impl crate::Readable for USERTCD0INPUTB_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usertcd0inputb::W`](W) writer structure"]
impl crate::Writable for USERTCD0INPUTB_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCD0INPUTB to value 0"]
impl crate::Resettable for USERTCD0INPUTB_SPEC {
