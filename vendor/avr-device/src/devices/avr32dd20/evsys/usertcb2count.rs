#[doc = "Register `USERTCB2COUNT` reader"]
pub type R = crate::R<USERTCB2COUNT_SPEC>;
#[doc = "Register `USERTCB2COUNT` writer"]
pub type W = crate::W<USERTCB2COUNT_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn user(&mut self) -> USER_W<USERTCB2COUNT_SPEC> {
        USER_W::new(self, 0)
    }
...
#[doc = "User 35 - TCB2 Event B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usertcb2count::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usertcb2count::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USERTCB2COUNT_SPEC;
impl crate::RegisterSpec for USERTCB2COUNT_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`usertcb2count::R`](R) reader structure"]
impl crate::Readable for USERTCB2COUNT_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usertcb2count::W`](W) writer structure"]
impl crate::Writable for USERTCB2COUNT_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCB2COUNT to value 0"]
impl crate::Resettable for USERTCB2COUNT_SPEC {
