...
pub type R = crate::R<USERTCA0CNTB_SPEC>;
#[doc = "Register `USERTCA0CNTB` writer"]
pub type W = crate::W<USERTCA0CNTB_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn user(&mut self) -> USER_W<USERTCA0CNTB_SPEC> {
        USER_W::new(self, 0)
    }
