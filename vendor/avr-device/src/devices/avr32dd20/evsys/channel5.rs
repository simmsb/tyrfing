...
pub type R = crate::R<CHANNEL5_SPEC>;
#[doc = "Register `CHANNEL5` writer"]
pub type W = crate::W<CHANNEL5_SPEC>;
#[doc = "Field `CHANNEL5` reader - Channel 5 generator select"]
pub type CHANNEL5_R = crate::FieldReader<CHANNEL5_A>;
#[doc = "Channel 5 generator select\n\nValue on reset: 0"]
...
impl From<CHANNEL5_A> for u8 {
    #[inline(always)]
    fn from(variant: CHANNEL5_A) -> Self {
        variant as _
    }
}
impl crate::FieldSpec for CHANNEL5_A {
    type Ux = u8;
}
impl CHANNEL5_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Option<CHANNEL5_A> {
        match self.bits {
            0 => Some(CHANNEL5_A::OFF),
            1 => Some(CHANNEL5_A::UPDI_SYNCH),
            5 => Some(CHANNEL5_A::MVIO),
            6 => Some(CHANNEL5_A::RTC_OVF),
            7 => Some(CHANNEL5_A::RTC_CMP),
            8 => Some(CHANNEL5_A::RTC_PIT_DIV512),
            9 => Some(CHANNEL5_A::RTC_PIT_DIV256),
            10 => Some(CHANNEL5_A::RTC_PIT_DIV128),
            11 => Some(CHANNEL5_A::RTC_PIT_DIV64),
            16 => Some(CHANNEL5_A::CCL_LUT0),
            17 => Some(CHANNEL5_A::CCL_LUT1),
            18 => Some(CHANNEL5_A::CCL_LUT2),
            19 => Some(CHANNEL5_A::CCL_LUT3),
            32 => Some(CHANNEL5_A::AC0_OUT),
            36 => Some(CHANNEL5_A::ADC0_RESRDY),
            48 => Some(CHANNEL5_A::ZCD3),
            78 => Some(CHANNEL5_A::PORTF_PIN6),
            79 => Some(CHANNEL5_A::PORTF_PIN7),
            96 => Some(CHANNEL5_A::USART0_XCK),
            97 => Some(CHANNEL5_A::USART1_XCK),
            104 => Some(CHANNEL5_A::SPI0_SCK),
            128 => Some(CHANNEL5_A::TCA0_OVF_LUNF),
            129 => Some(CHANNEL5_A::TCA0_HUNF),
            132 => Some(CHANNEL5_A::TCA0_CMP0_LCMP0),
            133 => Some(CHANNEL5_A::TCA0_CMP1_LCMP1),
            134 => Some(CHANNEL5_A::TCA0_CMP2_LCMP2),
            160 => Some(CHANNEL5_A::TCB0_CAPT),
            161 => Some(CHANNEL5_A::TCB0_OVF),
            162 => Some(CHANNEL5_A::TCB1_CAPT),
            163 => Some(CHANNEL5_A::TCB1_OVF),
            164 => Some(CHANNEL5_A::TCB2_CAPT),
            165 => Some(CHANNEL5_A::TCB2_OVF),
            176 => Some(CHANNEL5_A::TCD0_CMPBCLR),
            177 => Some(CHANNEL5_A::TCD0_CMPASET),
            178 => Some(CHANNEL5_A::TCD0_CMPBSET),
            179 => Some(CHANNEL5_A::TCD0_PROGEV),
            _ => None,
        }
    }
    #[doc = "Off"]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel5(&mut self) -> CHANNEL5_W<CHANNEL5_SPEC> {
        CHANNEL5_W::new(self, 0)
    }
...
#[doc = "Multiplexer Channel 5\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`channel5::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`channel5::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
