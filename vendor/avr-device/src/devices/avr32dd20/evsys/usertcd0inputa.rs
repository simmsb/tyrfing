#[doc = "Register `USERTCD0INPUTA` reader"]
pub type R = crate::R<USERTCD0INPUTA_SPEC>;
#[doc = "Register `USERTCD0INPUTA` writer"]
pub type W = crate::W<USERTCD0INPUTA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn user(&mut self) -> USER_W<USERTCD0INPUTA_SPEC> {
        USER_W::new(self, 0)
    }
...
#[doc = "User 40 - TCD0 Event A\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`usertcd0inputa::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`usertcd0inputa::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct USERTCD0INPUTA_SPEC;
impl crate::RegisterSpec for USERTCD0INPUTA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`usertcd0inputa::R`](R) reader structure"]
impl crate::Readable for USERTCD0INPUTA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`usertcd0inputa::W`](W) writer structure"]
impl crate::Writable for USERTCD0INPUTA_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USERTCD0INPUTA to value 0"]
impl crate::Resettable for USERTCD0INPUTA_SPEC {
