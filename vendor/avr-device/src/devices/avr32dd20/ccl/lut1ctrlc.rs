...
pub type R = crate::R<LUT1CTRLC_SPEC>;
#[doc = "Register `LUT1CTRLC` writer"]
pub type W = crate::W<LUT1CTRLC_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn insel2(&mut self) -> INSEL2_W<LUT1CTRLC_SPEC> {
        INSEL2_W::new(self, 0)
    }
...
#[doc = "LUT 1 Control C\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lut1ctrlc::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lut1ctrlc::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
