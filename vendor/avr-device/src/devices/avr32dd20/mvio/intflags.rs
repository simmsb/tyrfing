...
#[doc = "Field `VDDIO2IF` reader - VDDIO2 Interrupt Flag"]
pub type VDDIO2IF_R = crate::BitReader;
#[doc = "Field `VDDIO2IF` writer - VDDIO2 Interrupt Flag"]
pub type VDDIO2IF_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    #[doc = "Bit 0 - VDDIO2 Interrupt Flag"]
    #[inline(always)]
    pub fn vddio2if(&self) -> VDDIO2IF_R {
        VDDIO2IF_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - VDDIO2 Interrupt Flag"]
    #[inline(always)]
    #[must_use]
    pub fn vddio2if(&mut self) -> VDDIO2IF_W<INTFLAGS_SPEC> {
        VDDIO2IF_W::new(self, 0)
    }
