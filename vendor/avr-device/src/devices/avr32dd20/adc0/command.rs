...
#[doc = "Field `STCONV` reader - Start Conversion"]
pub type STCONV_R = crate::BitReader;
#[doc = "Field `STCONV` writer - Start Conversion"]
pub type STCONV_W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPCONV` reader - Stop Conversion"]
pub type SPCONV_R = crate::BitReader;
#[doc = "Field `SPCONV` writer - Stop Conversion"]
pub type SPCONV_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[doc = "Bit 1 - Stop Conversion"]
    #[inline(always)]
    pub fn spconv(&self) -> SPCONV_R {
        SPCONV_R::new(((self.bits >> 1) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Start Conversion"]
    ...
    #[inline(always)]
    #[must_use]
    pub fn spconv(&mut self) -> SPCONV_W<COMMAND_SPEC> {
        SPCONV_W::new(self, 1)
    }
