...
impl RegisterBlock {
    ...
    #[doc = "0x08 - Positive mux input"]
    #[inline(always)]
    pub const fn muxpos(&self) -> &MUXPOS {
        &self.muxpos
    }
    #[doc = "0x09 - Negative mux input"]
    #[inline(always)]
    pub const fn muxneg(&self) -> &MUXNEG {
        &self.muxneg
    }
    #[doc = "0x0a - Command"]
    #[inline(always)]
...
#[doc = "Interrupt Flags"]
pub mod intflags;
#[doc = "MUXNEG (rw) register accessor: Negative mux input\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`muxneg::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`muxneg::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@muxneg`]
module"]
pub type MUXNEG = crate::Reg<muxneg::MUXNEG_SPEC>;
