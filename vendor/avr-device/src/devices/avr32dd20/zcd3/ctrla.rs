...
#[doc = "Field `INVERT` reader - Invert signal from pin"]
pub type INVERT_R = crate::BitReader;
#[doc = "Field `INVERT` writer - Invert signal from pin"]
...
impl R {
    ...
    #[doc = "Bit 3 - Invert signal from pin"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn invert(&mut self) -> INVERT_W<CTRLA_SPEC> {
        INVERT_W::new(self, 3)
    }
    #[doc = "Bit 6 - Output Pad Enable"]
    #[inline(always)]
