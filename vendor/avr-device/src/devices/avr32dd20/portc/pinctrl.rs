#[doc = "Register `PIN%sCTRL` reader"]
pub type R = crate::R<PINCTRL_SPEC>;
#[doc = "Register `PIN%sCTRL` writer"]
pub type W = crate::W<PINCTRL_SPEC>;
...
pub type INLVL_R = crate::BitReader;
#[doc = "Field `INLVL` writer - Input level select"]
pub type INLVL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn isc(&mut self) -> ISC_W<PINCTRL_SPEC> {
        ISC_W::new(self, 0)
    }
    #[doc = "Bit 3 - Pullup enable"]
    #[inline(always)]
    #[must_use]
    pub fn pullupen(&mut self) -> PULLUPEN_W<PINCTRL_SPEC> {
        PULLUPEN_W::new(self, 3)
    }
    #[doc = "Bit 6 - Input level select"]
    #[inline(always)]
    #[must_use]
    pub fn inlvl(&mut self) -> INLVL_W<PINCTRL_SPEC> {
        INLVL_W::new(self, 6)
    }
    #[doc = "Bit 7 - Inverted I/O Enable"]
    #[inline(always)]
    #[must_use]
    pub fn inven(&mut self) -> INVEN_W<PINCTRL_SPEC> {
        INVEN_W::new(self, 7)
    }
...
#[doc = "Pin %s Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pinctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pinctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PINCTRL_SPEC;
impl crate::RegisterSpec for PINCTRL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`pinctrl::R`](R) reader structure"]
impl crate::Readable for PINCTRL_SPEC {}
#[doc = "`write(|w| ..)` method takes [`pinctrl::W`](W) writer structure"]
impl crate::Writable for PINCTRL_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PIN%sCTRL to value 0"]
impl crate::Resettable for PINCTRL_SPEC {
