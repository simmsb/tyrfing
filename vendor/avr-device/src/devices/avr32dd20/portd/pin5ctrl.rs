...
pub type R = crate::R<PIN5CTRL_SPEC>;
#[doc = "Register `PIN5CTRL` writer"]
pub type W = crate::W<PIN5CTRL_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn isc(&mut self) -> ISC_W<PIN5CTRL_SPEC> {
        ISC_W::new(self, 0)
    }
    #[doc = "Bit 3 - Pullup enable"]
    #[inline(always)]
    #[must_use]
    pub fn pullupen(&mut self) -> PULLUPEN_W<PIN5CTRL_SPEC> {
        PULLUPEN_W::new(self, 3)
    }
    #[doc = "Bit 6 - Input level select"]
    #[inline(always)]
    #[must_use]
    pub fn inlvl(&mut self) -> INLVL_W<PIN5CTRL_SPEC> {
        INLVL_W::new(self, 6)
    }
    #[doc = "Bit 7 - Inverted I/O Enable"]
    #[inline(always)]
    #[must_use]
    pub fn inven(&mut self) -> INVEN_W<PIN5CTRL_SPEC> {
        INVEN_W::new(self, 7)
    }
...
#[doc = "Pin 5 Control\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`pin5ctrl::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`pin5ctrl::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
