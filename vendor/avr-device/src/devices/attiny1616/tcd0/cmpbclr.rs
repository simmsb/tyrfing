...
#[doc = "Field `CMPBCLR` reader - Compare B Clear"]
pub type CMPBCLR_R = crate::FieldReader<u16>;
#[doc = "Field `CMPBCLR` writer - Compare B Clear"]
pub type CMPBCLR_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 12, u16>;
impl R {
    #[doc = "Bits 0:11 - Compare B Clear"]
    #[inline(always)]
    pub fn cmpbclr(&self) -> CMPBCLR_R {
        CMPBCLR_R::new(self.bits & 0x0fff)
    }
}
impl W {
    #[doc = "Bits 0:11 - Compare B Clear"]
    #[inline(always)]
    #[must_use]
    pub fn cmpbclr(&mut self) -> CMPBCLR_W<CMPBCLR_SPEC> {
        CMPBCLR_W::new(self, 0)
    }
