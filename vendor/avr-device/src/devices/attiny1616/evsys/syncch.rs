#[doc = "Register `SYNCCH%s` reader"]
pub type R = crate::R<SYNCCH_SPEC>;
#[doc = "Register `SYNCCH%s` writer"]
pub type W = crate::W<SYNCCH_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn syncch0(&mut self) -> SYNCCH0_W<SYNCCH_SPEC> {
...
#[doc = "Synchronous Channel %s Generator Selection\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`syncch::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`syncch::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SYNCCH_SPEC;
impl crate::RegisterSpec for SYNCCH_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`syncch::R`](R) reader structure"]
impl crate::Readable for SYNCCH_SPEC {}
#[doc = "`write(|w| ..)` method takes [`syncch::W`](W) writer structure"]
impl crate::Writable for SYNCCH_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets SYNCCH%s to value 0"]
impl crate::Resettable for SYNCCH_SPEC {
