#[doc = "Register `ASYNCCH%s` reader"]
pub type R = crate::R<ASYNCCH_SPEC>;
#[doc = "Register `ASYNCCH%s` writer"]
pub type W = crate::W<ASYNCCH_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn asyncch0(&mut self) -> ASYNCCH0_W<ASYNCCH_SPEC> {
...
#[doc = "Asynchronous Channel %s Generator Selection\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`asyncch::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`asyncch::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ASYNCCH_SPEC;
impl crate::RegisterSpec for ASYNCCH_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`asyncch::R`](R) reader structure"]
impl crate::Readable for ASYNCCH_SPEC {}
#[doc = "`write(|w| ..)` method takes [`asyncch::W`](W) writer structure"]
impl crate::Writable for ASYNCCH_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ASYNCCH%s to value 0"]
impl crate::Resettable for ASYNCCH_SPEC {
