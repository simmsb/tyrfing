...
pub type R = crate::R<USERROW22_SPEC>;
#[doc = "Register `USERROW22` writer"]
pub type W = crate::W<USERROW22_SPEC>;
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        write!(f, "{}", self.bits())
    }
}
impl core::fmt::Debug for crate::generic::Reg<USERROW22_SPEC> {
