#[doc = "Register `LUTCTRLA` reader"]
pub type R = crate::R<LUTCTRLA_SPEC>;
#[doc = "Register `LUTCTRLA` writer"]
pub type W = crate::W<LUTCTRLA_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<LUTCTRLA_SPEC> {
        ENABLE_W::new(self, 0)
    }
    #[doc = "Bit 3 - Output Enable"]
    #[inline(always)]
    #[must_use]
    pub fn outen(&mut self) -> OUTEN_W<LUTCTRLA_SPEC> {
        OUTEN_W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Filter Selection"]
    #[inline(always)]
    #[must_use]
    pub fn filtsel(&mut self) -> FILTSEL_W<LUTCTRLA_SPEC> {
        FILTSEL_W::new(self, 4)
    }
    #[doc = "Bit 6 - Clock Source Selection"]
    #[inline(always)]
    #[must_use]
    pub fn clksrc(&mut self) -> CLKSRC_W<LUTCTRLA_SPEC> {
        CLKSRC_W::new(self, 6)
    }
    #[doc = "Bit 7 - Edge Detection Enable"]
    #[inline(always)]
    #[must_use]
    pub fn edgedet(&mut self) -> EDGEDET_W<LUTCTRLA_SPEC> {
...
#[doc = "LUT Control 0 A\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`lutctrla::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`lutctrla::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct LUTCTRLA_SPEC;
impl crate::RegisterSpec for LUTCTRLA_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [`lutctrla::R`](R) reader structure"]
impl crate::Readable for LUTCTRLA_SPEC {}
#[doc = "`write(|w| ..)` method takes [`lutctrla::W`](W) writer structure"]
impl crate::Writable for LUTCTRLA_SPEC {
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LUTCTRLA to value 0"]
impl crate::Resettable for LUTCTRLA_SPEC {
