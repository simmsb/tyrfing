...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pg0(&mut self) -> PG0_W<PING_SPEC> {
        PG0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin G1"]
    #[inline(always)]
    #[must_use]
    pub fn pg1(&mut self) -> PG1_W<PING_SPEC> {
        PG1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin G2"]
    #[inline(always)]
    #[must_use]
    pub fn pg2(&mut self) -> PG2_W<PING_SPEC> {
        PG2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin G3"]
    #[inline(always)]
    #[must_use]
    pub fn pg3(&mut self) -> PG3_W<PING_SPEC> {
        PG3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin G4"]
    #[inline(always)]
    #[must_use]
    pub fn pg4(&mut self) -> PG4_W<PING_SPEC> {
        PG4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin G5"]
    #[inline(always)]
    #[must_use]
    pub fn pg5(&mut self) -> PG5_W<PING_SPEC> {
        PG5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin G6"]
    #[inline(always)]
    #[must_use]
    pub fn pg6(&mut self) -> PG6_W<PING_SPEC> {
        PG6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin G7"]
    #[inline(always)]
    #[must_use]
    pub fn pg7(&mut self) -> PG7_W<PING_SPEC> {
        PG7_W::new(self, 7)
    }
