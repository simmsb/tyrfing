...
pub type R = crate::R<DDRJ_SPEC>;
#[doc = "Register `DDRJ` writer"]
pub type W = crate::W<DDRJ_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pj0(&mut self) -> PJ0_W<DDRJ_SPEC> {
        PJ0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin J1"]
    #[inline(always)]
    #[must_use]
    pub fn pj1(&mut self) -> PJ1_W<DDRJ_SPEC> {
        PJ1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin J2"]
    #[inline(always)]
    #[must_use]
    pub fn pj2(&mut self) -> PJ2_W<DDRJ_SPEC> {
        PJ2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin J3"]
    #[inline(always)]
    #[must_use]
    pub fn pj3(&mut self) -> PJ3_W<DDRJ_SPEC> {
        PJ3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin J4"]
    #[inline(always)]
    #[must_use]
    pub fn pj4(&mut self) -> PJ4_W<DDRJ_SPEC> {
        PJ4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin J5"]
    #[inline(always)]
    #[must_use]
    pub fn pj5(&mut self) -> PJ5_W<DDRJ_SPEC> {
        PJ5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin J6"]
    #[inline(always)]
    #[must_use]
    pub fn pj6(&mut self) -> PJ6_W<DDRJ_SPEC> {
        PJ6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin J7"]
    #[inline(always)]
    #[must_use]
    pub fn pj7(&mut self) -> PJ7_W<DDRJ_SPEC> {
        PJ7_W::new(self, 7)
    }
...
#[doc = "PORT J Data Direction Register\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`ddrj::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`ddrj::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
