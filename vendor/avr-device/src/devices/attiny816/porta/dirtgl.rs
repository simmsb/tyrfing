...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pa0(&mut self) -> PA0_W<DIRTGL_SPEC> {
        PA0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin A1"]
    #[inline(always)]
    #[must_use]
    pub fn pa1(&mut self) -> PA1_W<DIRTGL_SPEC> {
        PA1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin A2"]
    #[inline(always)]
    #[must_use]
    pub fn pa2(&mut self) -> PA2_W<DIRTGL_SPEC> {
        PA2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin A3"]
    #[inline(always)]
    #[must_use]
    pub fn pa3(&mut self) -> PA3_W<DIRTGL_SPEC> {
        PA3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin A4"]
    #[inline(always)]
    #[must_use]
    pub fn pa4(&mut self) -> PA4_W<DIRTGL_SPEC> {
        PA4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin A5"]
    #[inline(always)]
    #[must_use]
    pub fn pa5(&mut self) -> PA5_W<DIRTGL_SPEC> {
        PA5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin A6"]
    #[inline(always)]
    #[must_use]
    pub fn pa6(&mut self) -> PA6_W<DIRTGL_SPEC> {
        PA6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin A7"]
    #[inline(always)]
    #[must_use]
    pub fn pa7(&mut self) -> PA7_W<DIRTGL_SPEC> {
        PA7_W::new(self, 7)
    }
