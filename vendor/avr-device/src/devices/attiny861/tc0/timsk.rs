...
pub type TICIE0_R = crate::BitReader;
#[doc = "Field `TICIE0` writer - Timer/Counter0 Input Capture Interrupt Enable"]
pub type TICIE0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ticie0(&mut self) -> TICIE0_W<TIMSK_SPEC> {
        TICIE0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Timer/Counter0 Overflow Interrupt Enable"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn ocie0b(&mut self) -> OCIE0B_W<TIMSK_SPEC> {
        OCIE0B_W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer/Counter0 Output Compare Match A Interrupt Enable"]
    #[inline(always)]
    #[must_use]
    pub fn ocie0a(&mut self) -> OCIE0A_W<TIMSK_SPEC> {
        OCIE0A_W::new(self, 4)
    }
