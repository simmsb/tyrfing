...
pub type ICF0_R = crate::BitReader;
#[doc = "Field `ICF0` writer - Timer/Counter0 Input Capture Flag"]
pub type ICF0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn icf0(&mut self) -> ICF0_W<TIFR_SPEC> {
        ICF0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Timer/Counter0 Overflow Flag"]
    #[inline(always)]
    #[must_use]
    pub fn tov0(&mut self) -> TOV0_W<TIFR_SPEC> {
        TOV0_W::new(self, 1)
    }
    #[doc = "Bit 3 - Timer/Counter0 Output Compare Flag 0B"]
    #[inline(always)]
    #[must_use]
    pub fn ocf0b(&mut self) -> OCF0B_W<TIFR_SPEC> {
        OCF0B_W::new(self, 3)
    }
    #[doc = "Bit 4 - Timer/Counter0 Output Compare Flag 0A"]
    #[inline(always)]
    #[must_use]
    pub fn ocf0a(&mut self) -> OCF0A_W<TIFR_SPEC> {
        OCF0A_W::new(self, 4)
    }
