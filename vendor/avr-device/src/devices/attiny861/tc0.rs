...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn tcnt0h(&self) -> &TCNT0H {
        &self.tcnt0h
    }
    ...
    #[inline(always)]
    pub const fn tcnt0l(&self) -> &TCNT0L {
        &self.tcnt0l
    }
...
pub mod tccr0b;
#[doc = "TCNT0H (rw) register accessor: Timer/Counter0 High\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tcnt0h::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tcnt0h::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tcnt0h`]
module"]
pub type TCNT0H = crate::Reg<tcnt0h::TCNT0H_SPEC>;
#[doc = "Timer/Counter0 High"]
pub mod tcnt0h;
#[doc = "TCNT0L (rw) register accessor: Timer/Counter0 Low\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`tcnt0l::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`tcnt0l::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tcnt0l`]
module"]
