...
pub type GSEL_R = crate::BitReader;
#[doc = "Field `GSEL` writer - Gain Select"]
pub type GSEL_W<'a, REG> = crate::BitWriter<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn refs2(&mut self) -> REFS2_W<ADCSRB_SPEC> {
        REFS2_W::new(self, 4)
    }
    #[doc = "Bit 5 - Input Polarity Mode"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn gsel(&mut self) -> GSEL_W<ADCSRB_SPEC> {
        GSEL_W::new(self, 6)
    }
    #[doc = "Bit 7 - Bipolar Input Mode"]
    #[inline(always)]
