...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pf0(&mut self) -> PF0_W<DIRCLR_SPEC> {
        PF0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin F1"]
    #[inline(always)]
    #[must_use]
    pub fn pf1(&mut self) -> PF1_W<DIRCLR_SPEC> {
        PF1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin F2"]
    #[inline(always)]
    #[must_use]
    pub fn pf2(&mut self) -> PF2_W<DIRCLR_SPEC> {
        PF2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin F3"]
    #[inline(always)]
    #[must_use]
    pub fn pf3(&mut self) -> PF3_W<DIRCLR_SPEC> {
        PF3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin F4"]
    #[inline(always)]
    #[must_use]
    pub fn pf4(&mut self) -> PF4_W<DIRCLR_SPEC> {
        PF4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin F5"]
    #[inline(always)]
    #[must_use]
    pub fn pf5(&mut self) -> PF5_W<DIRCLR_SPEC> {
        PF5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin F6"]
    #[inline(always)]
