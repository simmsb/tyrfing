...
pub type R = crate::R<USEREVOUTF_SPEC>;
#[doc = "Register `USEREVOUTF` writer"]
pub type W = crate::W<USEREVOUTF_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USEREVOUTF_SPEC> {
...
#[doc = "User EVOUT Port F\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userevoutf::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userevoutf::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
