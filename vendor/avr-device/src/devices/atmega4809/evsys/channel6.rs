...
pub type R = crate::R<CHANNEL6_SPEC>;
#[doc = "Register `CHANNEL6` writer"]
pub type W = crate::W<CHANNEL6_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn generator(&mut self) -> GENERATOR_W<CHANNEL6_SPEC> {
