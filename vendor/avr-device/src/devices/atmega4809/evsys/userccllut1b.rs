...
pub type R = crate::R<USERCCLLUT1B_SPEC>;
#[doc = "Register `USERCCLLUT1B` writer"]
pub type W = crate::W<USERCCLLUT1B_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USERCCLLUT1B_SPEC> {
...
#[doc = "User CCL LUT1 Event B\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userccllut1b::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userccllut1b::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
