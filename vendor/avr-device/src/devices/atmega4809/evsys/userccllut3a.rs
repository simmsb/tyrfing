...
pub type R = crate::R<USERCCLLUT3A_SPEC>;
#[doc = "Register `USERCCLLUT3A` writer"]
pub type W = crate::W<USERCCLLUT3A_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USERCCLLUT3A_SPEC> {
