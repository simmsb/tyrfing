...
pub type R = crate::R<USERCCLLUT1A_SPEC>;
#[doc = "Register `USERCCLLUT1A` writer"]
pub type W = crate::W<USERCCLLUT1A_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USERCCLLUT1A_SPEC> {
