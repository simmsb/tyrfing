...
pub type R = crate::R<USEREVOUTD_SPEC>;
#[doc = "Register `USEREVOUTD` writer"]
pub type W = crate::W<USEREVOUTD_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USEREVOUTD_SPEC> {
...
#[doc = "User EVOUT Port D\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userevoutd::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userevoutd::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
