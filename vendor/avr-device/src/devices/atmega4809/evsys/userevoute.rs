...
pub type R = crate::R<USEREVOUTE_SPEC>;
#[doc = "Register `USEREVOUTE` writer"]
pub type W = crate::W<USEREVOUTE_SPEC>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn channel(&mut self) -> CHANNEL_W<USEREVOUTE_SPEC> {
...
#[doc = "User EVOUT Port E\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`userevoute::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`userevoute::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
