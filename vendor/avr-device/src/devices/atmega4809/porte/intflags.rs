...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pe0(&mut self) -> PE0_W<INTFLAGS_SPEC> {
        PE0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin E1"]
    #[inline(always)]
    #[must_use]
    pub fn pe1(&mut self) -> PE1_W<INTFLAGS_SPEC> {
        PE1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin E2"]
    #[inline(always)]
    #[must_use]
    pub fn pe2(&mut self) -> PE2_W<INTFLAGS_SPEC> {
        PE2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin E3"]
    #[inline(always)]
    #[must_use]
    pub fn pe3(&mut self) -> PE3_W<INTFLAGS_SPEC> {
        PE3_W::new(self, 3)
    }
