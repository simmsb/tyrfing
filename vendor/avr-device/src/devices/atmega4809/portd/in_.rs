...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pd0(&mut self) -> PD0_W<IN_SPEC> {
        PD0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin D1"]
    #[inline(always)]
    #[must_use]
    pub fn pd1(&mut self) -> PD1_W<IN_SPEC> {
        PD1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin D2"]
    #[inline(always)]
    #[must_use]
    pub fn pd2(&mut self) -> PD2_W<IN_SPEC> {
        PD2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin D3"]
    #[inline(always)]
    #[must_use]
    pub fn pd3(&mut self) -> PD3_W<IN_SPEC> {
        PD3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin D4"]
    #[inline(always)]
    #[must_use]
    pub fn pd4(&mut self) -> PD4_W<IN_SPEC> {
        PD4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin D5"]
    #[inline(always)]
    #[must_use]
    pub fn pd5(&mut self) -> PD5_W<IN_SPEC> {
        PD5_W::new(self, 5)
    }
    #[doc = "Bit 6 - Pin D6"]
    #[inline(always)]
    #[must_use]
    pub fn pd6(&mut self) -> PD6_W<IN_SPEC> {
        PD6_W::new(self, 6)
    }
    #[doc = "Bit 7 - Pin D7"]
    #[inline(always)]
    #[must_use]
    pub fn pd7(&mut self) -> PD7_W<IN_SPEC> {
        PD7_W::new(self, 7)
    }
