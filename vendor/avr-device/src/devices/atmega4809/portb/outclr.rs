...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pb0(&mut self) -> PB0_W<OUTCLR_SPEC> {
        PB0_W::new(self, 0)
    }
    #[doc = "Bit 1 - Pin B1"]
    #[inline(always)]
    #[must_use]
    pub fn pb1(&mut self) -> PB1_W<OUTCLR_SPEC> {
        PB1_W::new(self, 1)
    }
    #[doc = "Bit 2 - Pin B2"]
    #[inline(always)]
    #[must_use]
    pub fn pb2(&mut self) -> PB2_W<OUTCLR_SPEC> {
        PB2_W::new(self, 2)
    }
    #[doc = "Bit 3 - Pin B3"]
    #[inline(always)]
    #[must_use]
    pub fn pb3(&mut self) -> PB3_W<OUTCLR_SPEC> {
        PB3_W::new(self, 3)
    }
    #[doc = "Bit 4 - Pin B4"]
    #[inline(always)]
    #[must_use]
    pub fn pb4(&mut self) -> PB4_W<OUTCLR_SPEC> {
        PB4_W::new(self, 4)
    }
    #[doc = "Bit 5 - Pin B5"]
    #[inline(always)]
    #[must_use]
    pub fn pb5(&mut self) -> PB5_W<OUTCLR_SPEC> {
        PB5_W::new(self, 5)
    }
