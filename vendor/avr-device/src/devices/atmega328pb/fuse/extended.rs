...
impl CFD_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> CFD_A {
        match self.bits {
...
pub type CFD_W<'a, REG> = crate::BitWriter<'a, REG, CFD_A>;
impl<'a, REG> CFD_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn cfd_disabled(self) -> &'a mut crate::W<REG> {
        self.variant(CFD_A::CFD_DISABLED)
    }
    #[doc = "Enabled"]
    #[inline(always)]
    pub fn cfd_enabled(self) -> &'a mut crate::W<REG> {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cfd(&mut self) -> CFD_W<EXTENDED_SPEC> {
        CFD_W::new(self, 3)
    }
