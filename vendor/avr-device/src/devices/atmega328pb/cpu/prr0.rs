...
pub type PRSPI0_R = crate::BitReader;
#[doc = "Field `PRSPI0` writer - Power Reduction Serial Peripheral Interface 1"]
pub type PRSPI0_W<'a, REG> = crate::BitWriter<'a, REG>;
...
pub type PRTWI0_R = crate::BitReader;
#[doc = "Field `PRTWI0` writer - Power Reduction TWI0"]
pub type PRTWI0_W<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn prspi0(&mut self) -> PRSPI0_W<PRR0_SPEC> {
        PRSPI0_W::new(self, 2)
    }
    #[doc = "Bit 3 - Power Reduction Timer/Counter1"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn prtwi0(&mut self) -> PRTWI0_W<PRR0_SPEC> {
        PRTWI0_W::new(self, 7)
    }
