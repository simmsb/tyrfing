...
pub type SRW1_R = crate::FieldReader<SRW1_A>;
...
impl crate::FieldSpec for SRW1_A {
    type Ux = u8;
}
impl SRW1_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> SRW1_A {
        match self.bits {
            0 => SRW1_A::VAL_0X00,
            1 => SRW1_A::VAL_0X01,
            2 => SRW1_A::VAL_0X02,
...
pub type SRW1_W<'a, REG> = crate::FieldWriterSafe<'a, REG, 2, SRW1_A>;
impl<'a, REG> SRW1_W<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
    REG::Ux: From<u8>,
{
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn srw1(&mut self) -> SRW1_W<XMCRA_SPEC> {
        SRW1_W::new(self, 2)
    }
    #[doc = "Bits 4:6 - Wait state page limit"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn sre(&mut self) -> SRE_W<XMCRA_SPEC> {
        SRE_W::new(self, 7)
    }
